                ...
                <form method="POST" action="{{ route('order.store') }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <textarea type="text" name="address_line_1" id="address_line_1"  class="form-control title" autocomplete="off" required>{{ !empty($order->address_line_1)?$order->address_line_1:'' }}</textarea>
                             </div>
                            <!--<div class="form-group">
                           ...
                           <!--  <div class="form-group">
                            ...
                            <input type="text" name="store_name" id="store_name" class="form-control title"  autocomplete="off" required value="{{ !empty($order->store_name)?$order->store_name:'' }}"/>
                             </div>
                            <div class="form-group">
                                <label for="Postcode">Address<span style="color:#F00">*</span></label>
                                <textarea type="text" name="delivery_address" id="delivery_address" class="form-control title" autocomplete="off"  required/>{{ !empty($order->delivery_address)?$order->delivery_address:'' }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="delivery_special_instructions" id="delivery_special_instructions" value="{{ !empty($order->delivery_special_instructions)?$order->delivery_special_instructions:'' }}" class="form-control title"  autocomplete="off"/>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="select-multi-input">Name<span style="color:#F00">*</span></label>
                                <input id="lego_name" name="lego_name" placeholder=""  class="form-control title" type="text" required value="{{ !empty($order->lego_name)?$order->lego_name:'' }}">
                            ...
                            <div class="form-group">
                                <label for="Postcode">Address<span style="color:#F00">*</span></label>
                                <textarea type="text"  name="billing_address" id="billing_address" class="form-control title" autocomplete="off" required/>{{ !empty($order->billing_address)?$order->billing_address:'' }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="Postcode">Country<span style="color:#F00">*</span></label>
