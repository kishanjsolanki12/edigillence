	...
	<div class="d-flex align-items-center logo-box justify-content-start">	
		...
		<a href="{{route('dashboard')}}" class="logo">
		  ...
		  <div class="logo-mini w-50">
			  <span class="light-logo"><img src="{{asset('images/main-logo.png')}}" alt="logo"></span>
			  <span class="dark-logo"><img src="{{asset('images/main-logo.png')}}" alt="logo"></span>
		  </div>
		  <div class="logo-lg">
				Admin Panel
