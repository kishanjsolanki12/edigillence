 <footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
	  ...
	  &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">eDigillence Admin</a>. All Rights Reserved.
  </footer>
...
<!-- ./wrapper -->
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{asset('images/2.jpg')}}" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="{{asset('images/3.jpg')}}" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
	...
	<script src="{{asset('js/bootstrap-datepaginator.min.js')}}"></script>
...
<!-- Mirrored from rhythm-admin-template.multipurposethemes.com/main/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Dec 2021 05:27:03 GMT -->
</html>
