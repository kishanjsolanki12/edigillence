                                            ...
                                            <select class="form-control appearance-none focus:shadow-outline" name="user_type" id="user_type" required>
                                                  <option value="">Select Role</option>
                                                    @foreach($roles as $key => $role)
                                                        <option value="{{ $role->id }}" @if($user->user_type == $role->id) selected @endif>{{ $role->name }}</option>
                                                    @endforeach
                                            </select>
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <textarea name="address" id="address" class="form-control focus:shadow-outline @error('address') is-invalid @enderror" value="{{ old('address') }}"  autocomplete="off">{{ old('address', $user->address) }}</textarea>
                                            @error('address')
