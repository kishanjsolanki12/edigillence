...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
        <form method="POST" action="{{ route('users.store') }}" class="form" novalidate data-parsley-validate="">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="name" id="name" class="form-control focus:shadow-outline @error('name') is-invalid @enderror" value="{{ !empty($user->name)?$user->name:''}}" autocomplete="off" required/>
                                            @error('name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            ...
                                            <select class="form-control appearance-none focus:shadow-outline" name="user_type" id="user_type" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="email" id="email" class="form-control focus:shadow-outline @error('email') is-invalid @enderror" value="{{ !empty($user->email)?$user->email:''}}" autocomplete="off" required/>
                                            @error('email')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="password" name="password" id="password" class="form-control focus:shadow-outline @error('password') is-invalid @enderror" autocomplete="off" required="" />
                                            @error('password')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-label">
                                            <label for="password_confirmation">Confirm Password<span style="color:#F00">*</span></label>
                                        </div>

                                        <div class="input-block">
                                            <input type="password" name="password_confirmation" id="password_confirmation" data-parsley-equalto="#password" class="form-control focus:shadow-outline" autocomplete="off"  required="" />
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <textarea name="address" id="address" class="form-control focus:shadow-outline @error('address') is-invalid @enderror" value="{{ old('address') }}"  autocomplete="off">{{ !empty($user->address)?$user->address:''}}</textarea>
                                            @error('address')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="pincode" id="pincode" class="form-control focus:shadow-outline @error('pincode') is-invalid @enderror" value="{{ !empty($user->pincode)?$user->pincode:''}}" autocomplete="off"  maxlength="10" />
                                            @error('pincode')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="google_location" id="google_location" class="form-control focus:shadow-outline @error('google_location') is-invalid @enderror" value="{{ !empty($user->google_location)?$user->google_location:''}}" autocomplete="off"   />
