        ...
        <div class="box">
          <div class="box-header">  
              ...
              @if (session('message'))
                                ...
                                <div class="alert-team bg-green-100 border-t-4 border-green-500 rounded-b text-green-900 " role="alert">
                                    <div class="flex">
              ...
              <div class="row">
                    ...
                    <div class="col-md-1">
                     <select id="per_page" name="per_page" tabindex="6" class="form-control forum forum_name team_listing" style="margin-left: 10px;">
                     ...
                     <div class="col-md-3">
                     <a href="/admin/teams/create" class="btn btn-primary float-right">Add New Team</a>
                    </div>
              </div>
          </div>
          <div class="box-body">
              ...
              <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
               <thead>
                        <tr class="text-left border-b-2 border-gray-300">
                            ...
                            <th class="px-4 py-3 sorting" data-sorting_type="asc" data-column_name="designation" style="cursor: pointer">Designation</th>
                            <th class="px-4 py-3 sorting" data-sorting_type="asc" data-column_name="status" style="cursor: pointer">Status</th>                              
                            <th class="px-4 py-3">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @include('admin.teams.team_pagination_data')
                    </tbody>
              </table>
...
$(document).ready(function(){
 ...
 {
  $('#id_icon').html('');
  $('#team_title_icon').html('');
 }

 function fetch_data(page, sort_type, sort_by, query, per_page)
 {
  $.ajax({
   url:"/admin/teams/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&per_page="+per_page,
 ...
 $(document).on('click', '.pagination a', function(event){
  ...
  $(document).on('click', '#reset_filter', function(){
   ...
   $('#from_date').val('');
   $('#to_date').val('');
   $('#hidden_column_name').val('teams.id');
   $('#hidden_sort_type').val('desc');
   $(".team_listing").select2();
   var query = $('#serach').val();
    var column_name = $('#hidden_column_name').val();
    var sort_type = $('#hidden_sort_type').val();
    var page = '1';
