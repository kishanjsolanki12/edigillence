        ...
        <div class="box">
          <div class="box-header">  
              ...
              @if (session('message'))
                                ...
                                <div class="alert-service bg-green-100 border-t-4 border-green-500 rounded-b text-green-900 " role="alert">
                                    <div class="flex">
              ...
              <div class="row">
                    ...
                    <div class="col-md-1">
                     <select id="per_page" name="per_page" tabindex="6" class="form-control forum forum_name service_listing" style="margin-left: 10px;">
                    ...
                    <div class="col-md-3">
                     <a href="/admin/services/create" class="btn btn-primary float-right">Add New Service</a>
                    </div>
              </div>
          </div>
          <div class="box-body">
            <div class="table-responsive">
              <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
               <thead>
                    ...
                    <tbody>
                        @include('admin.services.service_pagination_data')
                    </tbody>
              </table>
...
$(document).ready(function(){
 ...
 {
  $('#id_icon').html('');
  $('#service_title_icon').html('');
 }

 function fetch_data(page, sort_type, sort_by, query, per_page)
 {
  $.ajax({
   url:"/admin/services/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&per_page="+per_page,
 ...
 $(document).on('click', '.pagination a', function(event){
  ...
  $(document).on('click', '#reset_filter', function(){
   ...
   $('#from_date').val('');
   $('#to_date').val('');
   $('#hidden_column_name').val('services.id');
   $('#hidden_sort_type').val('desc');
   $(".service_listing").select2();
   var query = $('#serach').val();
    var column_name = $('#hidden_column_name').val();
    var sort_type = $('#hidden_sort_type').val();
    var page = '1';
