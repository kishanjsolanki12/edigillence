...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
        <form method="POST" action="{{ route('project.store') }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="project_url" id="project_url" class="form-control focus:shadow-outline @error('project_url') is-invalid @enderror" value="{{ !empty($page->project_url)?$page->project_url:''}}" autocomplete="off" required/>
                                            @error('project_url')
