        ...
        <div class="box">
          <div class="box-header">  
              ...
              <div class="row">
                    ...
                    <div class="col-md-3">
                     <a href="/admin/hiring/create" class="btn btn-primary float-right">Add New Hiring</a>
                    </div>
              </div>
          </div>
          <div class="box-body">
              ...
              <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
               <thead>
                        <tr class="text-left border-b-2 border-gray-300">
                            ...
                            <th class="px-4 py-3 sorting" data-sorting_type="asc" data-column_name="is_publish" style="cursor: pointer">Publish</th>                              
                            <th class="px-4 py-3">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @include('admin.hiring.hiring_pagination_data')
                    </tbody>
              </table>
