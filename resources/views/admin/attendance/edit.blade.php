...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
         <form method="POST" id="user-form" action="{{ route('attendance.update', $attendance) }}" class="form" novalidate data-parsley-validate="">
                        ...
                        <div class="box-body">
                                        ...
                                        <select class="form-control user_listing appearance-none focus:shadow-outline" name="user_type" id="user_type" required>
                                            <option value="">Select Employee</option>
                                                @foreach($users as $key => $user)
                                                    <option value="{{ $user->id }}"  @if($user->id == $attendance->user_id) selected @endif>{{ $user->name }} {{$user->surname}}</option>
                                                @endforeach
                                        </select>
                                        @error('user_type')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="time" name="clock_in" id="clock_in" value="{{ !empty($attendance->clock_in)?$attendance->clock_in:''}}" class="form-control focus:shadow-outline @error('clock_in') is-invalid @enderror" value="" autocomplete="off" required/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="time" name="break_start" id="break_start" value="{{ !empty($attendance->break_start)?$attendance->break_start:''}}" class="form-control focus:shadow-outline @error('break_start') is-invalid @enderror" value="" autocomplete="off" required/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="time" name="break_end" id="break_end" value="{{ !empty($attendance->break_end)?$attendance->break_end:''}}" class="form-control focus:shadow-outline @error('break_end') is-invalid @enderror" value="" autocomplete="off" required/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="time" name="clock_out" id="clock_out" value="{{ !empty($attendance->clock_out)?$attendance->clock_out:''}}" class="form-control focus:shadow-outline @error('clock_out') is-invalid @enderror" value="" autocomplete="off" required/>
