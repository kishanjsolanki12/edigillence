...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
        <form method="POST" action="{{ route('banners.update', $banner) }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            ...
                                            <img src="{{ Storage::disk()->url('banners/'.$banner->banner_image) }}" class="img-fluid img-thumbnail" width="150">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="is_publish" id="is_publish_1" class="form-check-input focus:shadow-outline @error('is_publish') is-invalid @enderror" value="1" required {{ ($banner->is_publish=="1")? "checked" : "" }} > 
                                            <label for="is_publish_1" class="form-check-label">Yes</label>
                                            <input type="radio" name="is_publish" id="is_publish_0" class="form-check-input focus:shadow-outline @error('is_publish') is-invalid @enderror" value="0" required {{ ($banner->is_publish=="0")? "checked" : "" }} > 
