...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
        <form method="POST" action="{{ route('blog.store') }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <textarea name="description" id="description" rows="3" class="form-control focus:shadow-outline @error('description') is-invalid @enderror" value="{{ old('description') }}" rows="10" autocomplete="off">{{ !empty($page->description)?$page->description:''}}</textarea>
                                            @error('description')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="upload_by" id="upload_by" class="form-control focus:shadow-outline @error('upload_by') is-invalid @enderror"  autocomplete="off" required/>
                                            @error('upload_by')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="date" name="date" id="date" class="form-control focus:shadow-outline @error('date') is-invalid @enderror" value="{{ !empty($blog->date)?$blog->title:''}}" autocomplete="off" required/>
                                            @error('title')
                                                <p class="help invalid-feedback">{{ $errors->first('title') }}</p>
                                            @enderror
                                        </div>
